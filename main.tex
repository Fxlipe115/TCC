...
\chapter{Evaluation}
    ...
    \section{Evaluation Strategy and Testbed}
        ...
        \label{subsec:hardware-software}
            ...
            To evaluate the implementation of the proposed scheme, we used three main tools: Locust for load testing, Gunicorn for deploying the backend, and Charm-Crypto for implementing cryptographic operations.
