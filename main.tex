...
\chapter{Evaluation}
    ...
    The performance evaluation was done with Locust\footnote{http://locust.io}...
    ...
    \section{Tests}
        ...
        Locust is a framework...
        
        workers vs threads etc

        According to locust documentation the optimal number of workers and threads is defined by the formula \ref{formula}. Given the specifications of table \ref{tab:machine_specs} the number of workers used in the tests is ...
