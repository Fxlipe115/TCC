...
\Laura{section: Resumo do Trabalho da Laura aqui}
\Laura{section: Modificações que o Grefo fez em cima}
% laura: pode ser uma seção só com tudo o que você fez, ou uma seção de overview e outras seções com os componentes (AES, etc)


\section{Libraries and Tools Used}
\Laura{essa parte vai no capitulo de experimental setup!}
