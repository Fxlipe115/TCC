...
\section{Motivation}
    \ToDo{Introduce the context of Laura's paper. \cite{laura2023} and its use of InterPlanetary File System (IPFS) \cite{benet2013ipfs}}
    
    \ToDo{Fundamentação teórica para explicar o IPFS}
